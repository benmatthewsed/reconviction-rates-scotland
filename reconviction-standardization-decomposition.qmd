...
-   The Sentencing Council (for England and Wales) says the reconviction rate is a "key metric for evaluating the effectiveness of sentencing" [@gormley2022]
...
-   Previously "Reduce reconviction rates" was a National Performance Framework indicator until (at least) 2017 [@scottishgovernment2017]

## But it's not so simple

-   However, "differences in the offending related characteristics of those included in each cohort make comparing reoffending rates problematic, across both time and jurisdictions." [@browne2024]
