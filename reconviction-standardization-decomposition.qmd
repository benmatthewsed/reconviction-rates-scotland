...
-   The @dasguptaStandardizationDecompositionRates1993 (see also [@kitagawa1964] approach to standardization and decomposition calculates what the reconviction rate 'would have been' in each comparison year if each year had the average demographic composition
