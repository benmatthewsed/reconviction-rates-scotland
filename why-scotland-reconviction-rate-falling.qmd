...
Over the past thirty years or so Scotland has seen consistent falls in police recorded crime, the number of people proceeded against in court, and since at least the late 2000s, the prevalence of victimization[^1]. This overall picture of declining crime rates across multiple measures of crime follows a familiar pattern seen across many parts of the global north known as the 'crime drop'.
