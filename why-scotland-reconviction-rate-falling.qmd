...
These figures are particular to the years used in the comparison. Figure Four shows the pairwise comparisons of the decomposition of each year from 1997/98 to 2010/11 and 2020/21. Sex structure had consistently small effects seen in Table One, we focus on the results for age structure and reconviction prevalence. Unsurprisingly the two lines are effectively the inverse of each other. Until the 2004/05 cohort the changes in age structure attributed more than half of the overall change in the reconviction rate. From the mid 2000s to the 2010/11 reconviction cohort between 40 and 55% of the fall in the reconviction rate between these cohorts and the 2020/21 cohort is attributable to changes in the age structure of the reconviction cohorts.
